      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <Link
              href="/"
              className="inline-block text-3xl font-black text-white tracking-tight"
            >
              DRINKO
            </Link>
            <p className="text-sm leading-relaxed text-gray-400">
              Refreshing the world one sip at a time. From classic colas to pure
              water, we craft beverages that delight every moment.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-500">
            &copy; {new Date().getFullYear()} Drinko. All rights reserved.
          </p>
          <p className="text-xs text-gray-500">
